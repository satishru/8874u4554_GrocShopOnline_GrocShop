			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header font-bold">
						<h2>
							{{ $product->product_name }}<a class="font-12 col-cyan" href="{{ route('product.index') }}">  Go To Products</a>	
						</h2>
					</div>
									...
									<table class="table">
										<tbody>
											...
											<tr>
												...
												<td>
													{{ $product->category->category_name }} <span class="font-12 col-cyan"> >> </span>
													{{ $product->subCategory->sub_category_name }} <span class="font-12 col-cyan"> >> </span>
												...
												<tr>
													...
													<td>
														<a href="{{ $image_path.$product_other_image->product_image }}" target="_blank">
																<img src="{{ $image_path.$product_other_image->product_image }}" width="120" height="80">
														</a>
													</td>
													<td>
														<br/>
														{!! 
													  	Utils::getDeleteButton(route('product.destroyProductOtherImage', $product_other_image->image_id))
													  !!}
													</td>
												</tr>
											@endforeach
