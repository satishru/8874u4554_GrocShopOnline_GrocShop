							...
							<div class="row clearfix">
								<div class="col-sm-2">
									<div class="form-group form-float">
										<div class="form-line">
											<input min="1" type="number" class="form-control" name="items_multiplier[{{$index}}]" value="{{ $productQuantity->items_multiplier }}" required>
								...
								<div class="col-sm-2">
									<div class="form-group form-float">
										<div class="form-line focused">
											<input min="0.1" type="number" class="form-control" name="product_quantity[{{$index}}]" 
								...
								<div class="col-sm-2" id="unit_dropdown">
									<div class="form-group">
										<select class="form-control show-tick selectUnit" name="unit_id[{{$index}}]" id="unit_dropdown_sel" required>
											<option value="">Select Unit*</option>
											@foreach($units as $indexKey => $unit)
											<option value="{{ $unit->unit_id }}" 
												@if ($unit->unit_id == $productQuantity->unit_id)
												selected="selected"
												@endif
												>
												{{ $unit->unit_name }}
								...
								<div class="col-sm-2">
									<div class="form-group form-float">
										<div class="form-line focused">
											<input min="0" type="number" class="form-control" name="product_offer_percent[{{$index}}]" 
								...
								<div class="col-sm-2">
									<div class="form-group">
										<input type="checkbox" name="quantity_in_stock[{{$index}}]" id="quantity_in_stock_{{ $index }}" class="filled-in" 
