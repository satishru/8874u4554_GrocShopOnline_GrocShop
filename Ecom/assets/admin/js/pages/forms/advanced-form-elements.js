$(function () {
    ...
    if (document.getElementById('nouislider_basic_example') && document.getElementById('nouislider_basic_example').value)
    {
    ...
    //Range Example
    if (document.getElementById('nouislider_range_example') && document.getElementById('nouislider_range_example').value)
    {
